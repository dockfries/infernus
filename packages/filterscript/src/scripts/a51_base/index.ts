...
import type { IA51BaseFS, IA51BaseFSOptions } from "./interfaces";

let i18n: I18n | null = null;
let _options: IA51BaseFSOptions | null = null;

function registerEvent(_options: IA51BaseFSOptions) {
...
function registerCommand(options: IA51BaseFSOptions) {
  const { command, onTeleport } = options;
