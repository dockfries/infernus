declare global {
  interface SampNodeApi {
    ...
    removeEventListener(eventName: string, func: (...args: Array<any>) => void): void;
    removeEventListener(eventName: string, funcs: Array<(...args: Array<any>) => void>): void;
    registerEvent(eventName: string, paramTypes: string): boolean;
    callNative(nativeName: string, paramTypes: string, ...args: Array<any>): any;
