import { DISABLE_MAPFIX_PLACE, MAPFIX_OBJECTS, MapFixObjects } from "../constants";
import {
  mf_CreateFloorObject,
  mf_CreateObject,
  mf_DestroyFloorObject,
  mf_DestroyObject,
  mf_SetObjectMaterial,
} from "./utils";

export function createMapFixObjects() {
  if (!DISABLE_MAPFIX_PLACE.has(1)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(12)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(13)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(14)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(15)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(16)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(17)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(26)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(27)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(28)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(31)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(37)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(45)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(48)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(49)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(50)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(51)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(52)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(53)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(54)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(55)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(58)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(59)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(66)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(71)) {
    MapFixObjects[257] = mf_CreateObject(3168, -640.5, 2717.2, 71.4, 0.0, 0.0, 42.0, 14.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(72)) {
    //by Jimmi, 0.3.7 objects are used
  ...
  if (!DISABLE_MAPFIX_PLACE.has(73)) {
    //by Walter Correa, 0.3e objects are used
    MapFixObjects[276] = mf_CreateFloorObject(
      19380,
      2530.5444,
      -1686.4581,
      1014.406,
    ...
    MapFixObjects[277] = mf_CreateFloorObject(
      19380,
      2530.5444,
      -1686.4581,
      1018.0872,
    ...
    MapFixObjects[278] = mf_CreateFloorObject(
      2987,
      2531.6193,
      -1683.7325,
      1015.0974,
    ...
    MapFixObjects[279] = mf_CreateObject(
      19380,
      2528.3588,
      -1685.8667,
      1012.8079,
    ...
    MapFixObjects[280] = mf_CreateObject(
      19380,
      2523.6545,
      -1682.6535,
      1012.8079,
    ...
    MapFixObjects[281] = mf_CreateObject(
      19380,
      2524.2971,
      -1681.1002,
      1012.8079,
    ...
    MapFixObjects[282] = mf_CreateObject(
      19380,
      2533.2294,
      -1685.9915,
      1012.8079,
    ...
    MapFixObjects[283] = mf_CreateObject(
      19380,
      2527.7893,
      -1685.9915,
      1012.8079,
    ...
    MapFixObjects[284] = mf_CreateObject(
      2987,
      2531.8166,
      -1680.9843,
      1016.0134,
    ...
    MapFixObjects[285] = mf_CreateObject(
      2987,
      2531.8166,
      -1681.2143,
      1016.0134,
    ...
    MapFixObjects[286] = mf_CreateObject(
      1566,
      2529.9609,
      -1681.0909,
      1018.9467,
    ...
    MapFixObjects[287] = mf_CreateObject(
      1566,
      2530.8859,
      -1681.3482,
      1015.8281,
    ...
    MapFixObjects[288] = mf_CreateObject(
      2948,
      2526.3342,
      -1681.8027,
      1014.9155,
    ...
    MapFixObjects[289] = mf_CreateObject(
      2948,
      2531.9921,
      -1675.7945,
      1014.9516,
    ...
    MapFixObjects[290] = mf_CreateObject(
      2948,
      2532.3266,
      -1681.723,
      1015.1895,
    ...
    MapFixObjects[291] = mf_CreateObject(
      2948,
      2534.84,
      -1672.7554,
      1014.9516,
    ...
    MapFixObjects[292] = mf_CreateObject(
      2948,
      2535.6123,
      -1672.7554,
      1014.9516,
    ...
    MapFixObjects[293] = mf_CreateObject(
      2948,
      2534.9394,
      -1676.5258,
      1015.2634,
    ...
    MapFixObjects[294] = mf_CreateObject(
      2948,
      2536.0615,
      -1676.5258,
      1015.2634,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(74)) {
    //by Apec & substantive., 0.3e objects are used
    MapFixObjects[295] = mf_CreateObject(
      19464,
      293.1319,
      -1616.1232,
      34.7051,
    ...
    MapFixObjects[297] = mf_CreateObject(
      19464,
      281.4706,
      -1614.0808,
      34.7051,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(75)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(76)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(77)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(80)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(86)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(87)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(88)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(91)) {
    //by KinG7
    MapFixObjects[356] = mf_CreateObject(1501, -383.46, -1439.64, 25.33, 0.0, 0.0, 90.0, 150.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(92)) {
    //by KinG7
    MapFixObjects[357] = mf_CreateObject(
      1505,
      -2574.495,
      1153.023,
      54.669,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(93)) {
    //by KinG7
    MapFixObjects[358] = mf_CreateObject(
      1496,
      -1800.7048,
      1201.0538,
      24.1293,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(97)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(98)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(101)) {
    //by Romzes, 0.3e objects are used
    MapFixObjects[375] = mf_CreateObject(19454, 242.593, -178.5028, 4.17, 0.0, 90.0, 0.0, 12.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(102)) {
    //by $continue$
  ...
  if (!DISABLE_MAPFIX_PLACE.has(105)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(108)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(109)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(114)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(115)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(116)) {
    MapFixObjects[419] = mf_CreateObject(3117, -2553.4, 1181.4, 43.9, 86.0, 60.0, 10.0, 6.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(117)) {
    //by Romzes, 0.3e objects are used
    MapFixObjects[420] = mf_CreateObject(
      19362,
      1209.8636,
      -16.1376,
      1001.9523,
    ...
    MapFixObjects[421] = mf_CreateObject(
      19362,
      1211.3809,
      -17.6581,
      1001.9523,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(123)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(124)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(125)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(126)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(127)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(128)) {
    //by Romzes, 0.3e objects are used
    MapFixObjects[457] = mf_CreateObject(
      19426,
      617.2022,
      -1124.6236,
      47.2562,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(129)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(130)) {
    //by reAL_
  ...
  if (!DISABLE_MAPFIX_PLACE.has(131)) {
    //by Sonic X, 0.3e objects are used
  ...
  if (!DISABLE_MAPFIX_PLACE.has(132)) {
    //by Romzes, 0.3e objects are used
  ...
  if (!DISABLE_MAPFIX_PLACE.has(135)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(138)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(139)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(140)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(141)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(142)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(143)) {
    //by _leon_lacartez_, 0.3e objects are used
    MapFixObjects[535] = mf_CreateObject(
      19377,
      2187.3974,
      1628.4919,
      1042.3125,
    ...
    MapFixObjects[536] = mf_CreateObject(
      19377,
      2191.6188,
      1628.4919,
      1042.3125,
    ...
    MapFixObjects[537] = mf_CreateObject(
      19377,
      2187.3974,
      1618.0515,
      1042.3125,
    ...
    MapFixObjects[538] = mf_CreateObject(
      19377,
      2191.6188,
      1618.0151,
      1042.3125,
    ...
    MapFixObjects[539] = mf_CreateObject(
      19377,
      2189.7272,
      1620.1258,
      1042.3125,
    ...
    MapFixObjects[540] = mf_CreateObject(
      19377,
      2175.1777,
      1620.1258,
      1042.3125,
    ...
    MapFixObjects[541] = mf_CreateFloorObject(
      19377,
      2182.8872,
      1628.7283,
      1042.3125,
    ...
    MapFixObjects[542] = mf_CreateFloorObject(
      19377,
      2182.8872,
      1619.1282,
      1042.3125,
    ...
    MapFixObjects[543] = mf_CreateFloorObject(
      19377,
      2193.3618,
      1628.7283,
      1042.3125,
    ...
    MapFixObjects[544] = mf_CreateFloorObject(
      19377,
      2193.3618,
      1619.1003,
      1042.3125,
    ...
    MapFixObjects[545] = mf_CreateObject(
      19377,
      2182.4968,
      1633.6617,
      1042.3125,
    ...
    MapFixObjects[546] = mf_CreateObject(
      19377,
      2177.5153,
      1628.4919,
      1042.3125,
    ...
    MapFixObjects[547] = mf_CreateObject(
      19377,
      2192.9362,
      1633.6617,
      1042.3125,
    ...
    MapFixObjects[548] = mf_CreateObject(
      19377,
      2182.4968,
      1619.3806,
      1042.3125,
    ...
    MapFixObjects[549] = mf_CreateObject(
      19377,
      2177.5153,
      1618.0323,
      1042.3125,
    ...
    MapFixObjects[550] = mf_CreateObject(
      19377,
      2182.737,
      1628.7283,
      1047.1828,
    ...
    MapFixObjects[551] = mf_CreateObject(
      19377,
      2193.1574,
      1628.7283,
      1047.1828,
    ...
    MapFixObjects[552] = mf_CreateObject(
      19377,
      2193.1574,
      1619.1281,
      1047.1828,
    ...
    MapFixObjects[553] = mf_CreateObject(
      19377,
      2182.7592,
      1619.1281,
      1047.1828,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(144)) {
    //by _leon_lacartez_, 0.3e objects are used
    MapFixObjects[554] = mf_CreateFloorObject(
      19377,
      447.1334,
      -107.2663,
      998.4553,
    ...
    MapFixObjects[555] = mf_CreateFloorObject(
      19377,
      457.5733,
      -107.2663,
      998.4553,
    ...
    MapFixObjects[556] = mf_CreateObject(
      19377,
      461.1731,
      -107.2663,
      997.5545,
    ...
    MapFixObjects[557] = mf_CreateObject(
      19377,
      441.7835,
      -107.2663,
      998.4854,
    ...
    MapFixObjects[558] = mf_CreateObject(
      19377,
      447.1334,
      -103.3863,
      998.4553,
    ...
    MapFixObjects[559] = mf_CreateObject(
      19377,
      457.6134,
      -103.4063,
      998.4553,
    ...
    MapFixObjects[560] = mf_CreateObject(
      19377,
      457.6134,
      -111.7963,
      998.4553,
    ...
    MapFixObjects[561] = mf_CreateObject(
      19377,
      447.1234,
      -111.7963,
      998.4553,
    ...
    MapFixObjects[562] = mf_CreateObject(
      19377,
      447.1334,
      -104.0,
      1002.3131,
    ...
    MapFixObjects[563] = mf_CreateObject(
      19377,
      457.5735,
      -104.0,
      1002.3131,
    ...
    MapFixObjects[564] = mf_CreateObject(
      19377,
      447.1334,
      -109.4549,
      1002.6306,
    ...
    MapFixObjects[565] = mf_CreateObject(
      19377,
      457.6135,
      -109.4549,
      1002.6306,
    ...
    MapFixObjects[566] = mf_CreateObject(
      19377,
      450.2434,
      -106.4663,
      994.7451,
    ...
    MapFixObjects[567] = mf_CreateObject(
      19377,
      460.6732,
      -106.4663,
      994.7451,
    ...
    MapFixObjects[568] = mf_CreateObject(
      19377,
      460.6732,
      -106.0064,
      994.7451,
    ...
    MapFixObjects[569] = mf_CreateObject(
      19377,
      450.2434,
      -106.0063,
      994.7451,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(145)) {
    //by _leon_lacartez_
  ...
  if (!DISABLE_MAPFIX_PLACE.has(146)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(147)) {
    //by Hare
  ...
  if (!DISABLE_MAPFIX_PLACE.has(148)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(149)) {
    //by MDarklight, 0.3e objects are used
    MapFixObjects[630] = mf_CreateObject(19437, 2766.7778, 178.68, 19.58, 90.0, 7.3, 90.0, 4.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(150)) {
    //by Vlad (Map Stock), 0.3e objects are used
  ...
  if (!DISABLE_MAPFIX_PLACE.has(153)) {
  ...
  if (!DISABLE_MAPFIX_PLACE.has(154)) {
    MapFixObjects[639] = mf_CreateObject(3037, 1089.7, -1485.5, 19.3, 0.0, 0.0, 286.0, 12.0);
  }
  if (!DISABLE_MAPFIX_PLACE.has(155)) {
    //by Tornamic, 0.3c objects are used
    ...
    MapFixObjects[643] = mf_CreateObject(
      18980,
      -595.4387,
      1938.997,
      16.372,
    ...
    MapFixObjects[644] = mf_CreateObject(
      18762,
      -601.4393,
      1940.452,
      27.8096,
    ...
    MapFixObjects[646] = mf_CreateObject(
      18762,
      -604.6,
      1927.2613,
      27.8096,
    ...
    MapFixObjects[647] = mf_CreateObject(
      18762,
      -607.7815,
      1914.0113,
      27.8096,
    ...
    MapFixObjects[648] = mf_CreateObject(
      18980,
      -603.372,
      1905.9567,
      16.372,
    ...
    MapFixObjects[649] = mf_CreateObject(
      18980,
      -600.2116,
      1919.1474,
      16.372,
    ...
    MapFixObjects[650] = mf_CreateObject(
      18762,
      -606.2122,
      1920.6024,
      27.8096,
    ...
    MapFixObjects[651] = mf_CreateObject(
      18762,
      -609.3726,
      1907.4117,
      27.8096,
    ...
    MapFixObjects[652] = mf_CreateObject(
      18980,
      -609.2677,
      1919.7518,
      27.7857,
    ...
    MapFixObjects[653] = mf_CreateObject(
      18980,
      -606.9364,
      1929.4665,
      27.7857,
  ...
  if (!DISABLE_MAPFIX_PLACE.has(156)) {
...
export function destroyMapFixObjects() {
  try {
    for (let i = MAPFIX_OBJECTS - 1; i >= 0; --i) {
      if (MapFixObjects[i]) {
        if (
          i === 97 ||
          (i >= 276 && i <= 278) ||
          ...
          mf_DestroyFloorObject(MapFixObjects[i]);
        } else {
          mf_DestroyObject(MapFixObjects[i]);
        }
      }
    }
  } finally {
    MapFixObjects.length = 0;
  }
  return 1;
}

export function toggleMapFixPlace(placeId: number, enable: boolean) {
  if (enable) {
    DISABLE_MAPFIX_PLACE.delete(placeId);
  } else {
    DISABLE_MAPFIX_PLACE.add(placeId);
  }
}
