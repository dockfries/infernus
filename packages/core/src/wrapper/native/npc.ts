...
export const NPC_SetVehiclePos = (id: number, x: number, y: number, z: number) => {
  return !!samp.callNative("NPC_SetVehiclePos", "ifff", id, x, y, z);
};

export const NPC_SetVehicleRot = (id: number, x: number, y: number, z: number) => {
  return !!samp.callNative("NPC_SetVehicleRot", "ifff", id, x, y, z);
};
