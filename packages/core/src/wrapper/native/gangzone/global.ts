...
export const UseGangZoneCheck = (zoneId: number, toggle: boolean): boolean => {
...
export const GangZoneDestroy = (zone: number): boolean => {
...
export const GangZoneHideForAll = (zone: number): boolean => {
...
export const GangZoneStopFlashForAll = (zone: number): boolean => {
