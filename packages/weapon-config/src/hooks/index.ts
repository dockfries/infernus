...
hook(Player, "setHealth", function (next, health) {
  // `next` is previously defined hooks or the original setHealth method.
  // Since weapon-config intercepts hooks and does not consider call other hooks, the next function is not used.
