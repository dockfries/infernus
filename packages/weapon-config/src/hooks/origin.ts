...
export const orig_TextDrawBackgroundColor = TextDraw.__inject__.setBackgroundColor;
...
export const orig_TextDrawSetPreviewVehCol = TextDraw.__inject__.setPreviewVehicleColors;
export const orig_IsValidTextDraw = TextDraw.__inject__.isValid;
export const orig_IsTextDrawVisibleForPlayer = TextDraw.__inject__.isVisibleForPlayer;
...
export const orig_TextDrawGetBackgroundColor = TextDraw.__inject__.getBackgroundColor;
...
export const orig_TextDrawSetStringForPlayer = TextDraw.__inject__.setStringForPlayer;
export const orig_TextDrawGetPreviewVehCol = TextDraw.__inject__.getPreviewVehicleColors;
