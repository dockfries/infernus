...
[![npm](https://img.shields.io/npm/v/@infernus/weapon-config)](https://www.npmx.dev/package/@infernus/weapon-config) ![npm](https://img.shields.io/npm/dw/@infernus/weapon-config) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@infernus/weapon-config)
