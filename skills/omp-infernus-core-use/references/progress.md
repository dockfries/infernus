...
// Methods
bar.getValue();            bar.setValue(75);        // → boolean
bar.getMinValue();         bar.setMinValue(0);      // → boolean
bar.getMaxValue();         bar.setMaxValue(100);    // → boolean
bar.getPos();              // → { x, y }
bar.setPos(x, y);          // → boolean
bar.getWidth();            bar.setWidth(w);         // → boolean
bar.getHeight();           bar.setHeight(h);        // → boolean
bar.getDirection();        bar.setDirection(dir);   // → boolean
bar.getPadding();          bar.setPadding(x, y);    // → boolean
bar.getColor();            bar.setColor(color);     // → boolean
bar.isValid();             // → boolean
bar.show();                bar.hide();
